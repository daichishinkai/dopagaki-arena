...
export const BALANCE = {
  ...
  danmaku: {
    ...
    /**
     * 難易度（裁定66・ユーザー要望）。形態ごとの数値に倍率を掛ける。
  ...
  classes: {
    ...
    heavy: { crossSeconds: 4.0, damageTaken: 0.85, shieldMax: 100, shieldTimeRegen: false },
    support: { crossSeconds: 4.0, damageTaken: 1.0, shieldMax: 50, shieldTimeRegen: true },
  },
